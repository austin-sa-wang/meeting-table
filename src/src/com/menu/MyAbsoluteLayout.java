 ...
 * 
 * <p>
 * Note: This class is a clone of AbsoluteLayout, which is now deprecated. This
 * class serves as a functioning placeholder of a custom LayoutManager. It is
 * advised to create a custom LayoutManager for our purpose instead of using the
...
public class MyAbsoluteLayout extends ViewGroup {
	...
	public void updateLayout(View v, int w, int h, int x, int y) {
		MyAbsoluteLayout.LayoutParams mylp = (MyAbsoluteLayout.LayoutParams) v
				.getLayoutParams();
		if (w > 0) {
			mylp.width = w;
		}
